...
#'          for(q in c(0.1,0.2))
#'          {
#'             power <- ccsize(n,q,pD,p1,theta,alpha)
...
#' {
#'   q <- s_nb[i]/n
#'   power <- ccsize(n,q,pD,p1,log(theta[i],alpha))
#'   ssize <- ccsize(n,q,pD,p1,log(theta[i]),alpha,beta1)
...
#'          for(q in s_q)
#'          {
#'             power <- ccsize(n,q,pD,p1,log(hr),alpha)
