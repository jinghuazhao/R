...
allows for Citation Style Language (CSL) (https://citationstyles.org/) to format
the bibliography.
2. multiple figures generated from a code section to be embedded.
3. Experimental implementation of a shiny App (`runshinygap`()).
4. **roxygen2** style documentation in companion with R code to allow for easier
generation of .Rd files through devtools::document().
...
which do not produce outputs for certain configurations.
