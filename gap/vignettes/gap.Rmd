...
df <- read.table(outfile, header=TRUE, sep="\t", stringsAsFactors=FALSE)
df$alpha <- formatC(as.numeric(df$alpha), format="e", digits=2)
knitr::kable(df,caption="Sample size of case-cohort designs")
unlink(outfile)
```
