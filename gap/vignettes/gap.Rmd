...
```{r il12b, echo=FALSE, fig.cap="Association of IL-12B", fig.height=7, fig.width=8}
...
```{r mr_forestplot, fig.cap="Forest plots based on MR results on TNFB", fig.height=8, fig.width=12, results="hide"}
# default output
mr_forestplot(tnfb,colgap.forest.left="0.5cm",fontsize=24,leftlabs=c("Outcome","b","SE"), spacing=1.6)
# no summary level statistics
mr_forestplot(tnfb, colgap.forest.left="0.5cm", fontsize=24,
              leftlabs=c("Outcome","b","SE"), rightlabs="ci", plotwidth="5inch",sm="OR",
