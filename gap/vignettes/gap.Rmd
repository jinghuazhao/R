...
author: "Jing Hua Zhao\\Department of Public Health and Primary Care, University of Cambridge, Cambridge, UK, https://jinghuazhao.github.io/."
date: '`r Sys.Date()`'
bibliography: gap.bib
csl: nature-genetics.csl
nocite: |
  @chow60, @devlin99, @elston75, @guo00, @guo92, @gholamic94, @hartung08, @hirotsu01, @kotz06, @miller97, risch96, @risch97, @sham97, @sham98, @skol06, @@spielman96, @wacholder04, @wakefield07, @wcn92, @wang05, @zaykin02, @zhao99, @zhao02, @zhao04
vignette: >
...
e.g. Guo ang Lange (2000)@guo00, within the portable environment of R for data management,
analysis, graphics and object-oriented programming. My view has been outlined
more formally[@zt06a; @zt06b] in relation to other package systems. Also reported
are Zhao (2005)@zhao05 and Zhao (2006)@zhao06 on package **kinship**.
...
The nearest reference for the implemented approaches is Ligthart et al. (2018)@ligthart18.
...
We now have results 1 and 2 below.
...
standard error is based on $r^2$ instead of variance of the ratio.
...
[^1]: [https://www.stat.cmu.edu/~hseltman/files/ratio.pdf](https://www.stat.cmu.edu/~hseltman/files/ratio.pdf)
