...
```{r pve, echo=FALSE, fig.caption="Scale factors as function of sample size (N)", fig.height=8, fig.width=8)
N <- 2:500
LR <- (N-2)*(N+1)/(N-1)^2
t <- (N-2)/(N+1)
...
It turns out that they approch 1 after $N>300$ from opposite directions with small sample size.
