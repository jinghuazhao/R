...
```{r, fig.cap="Forest plots for MR results on TNFB (default)", fig.align="left", fig.height=6, fig.width=9, results="hide"}
...
By now the package should have given you a flavor of the project. It is clear
that availability of the package builds a infrastructure with which future
work can be accumulated and collaboration can be built. It is also likely
to inspire others to join the efforts to develop their own packages.
