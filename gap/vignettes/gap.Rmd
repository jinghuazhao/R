...
1. Documentaion from R code via **roxygen2** and `devtools::document()`to allow
   for easier generation of  the .Rd files and NAMESPACE.

2. vignettes with noweb/Sweave as well as **rmarkdown** and **bookdown** which
   allows for Citation Style Language (CSL) (https://citationstyles.org/), and
   multiple figures generated from a code chunk. **Rdpack** now unifies BibTeX
   citations though CSL is not yet supported for the .Rd files.
