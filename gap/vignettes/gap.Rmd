...
METAL @willer10 and `find_qtls` which extracts sentinels from GWAS summary statistics
...
find_qtls         |      Distance-based signal identification
...
A distance-based signal identification based on GWAS summary statistics is implemented
in `find_qtls` function; to avoid the overhead of data-loading it works on a preselected
list of variants from a GWAS and in this case a METAL output file.
