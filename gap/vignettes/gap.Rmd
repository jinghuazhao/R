...
GENECOUNTING, HAP @zhao04, now hosted at GitHub, have enjoyed great popularity ahead of the
...
I have also included `ms` code @hudson02, which is required by `read.ms.output`.
