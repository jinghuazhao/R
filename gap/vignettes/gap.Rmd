...
for a list in alphabetical order, or `?gap::gap` one ordered by category, or view the
list within a web browser via `help.start()`. A full list of functions is provided in
the Appendix.
