...
in alphabetical order, or `?gap::gap` one ordered by category, or view it within a
web browser via `help.start()`. A full list of functions is provided in the Appendix.
