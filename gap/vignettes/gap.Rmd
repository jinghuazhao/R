...
```{r mr_forestplot_default, fig.cap="Forest plots based on MR results on TNFB (default)", fig.align="left", fig.height=6, fig.width=9, results="hide"}
...
```{r mr_forestplot_noss, fig.cap="Forest plots based on MR results on TNFB" (no summary statistics), fig.align="left", fig.height=6, fig.width=9, results="hide"}
...
```{r mr_forestplot_p, fig.cap="Forest plots based on MR results on TNFB (with P values)", fig.align="left", fig.height=6, fig.width=9, results="hide"}
mr_forestplot(tnfb,colgap.forest.left="0.05cm", fontsize=14,
