...
We also demonstrate through pedigree 10081 example with `pedtodot`.
...
```{r pedtodot, fig.cap="10081", fig.height=8, fig.width=7}
print(p3)
library(DOT)
pedtodot_verbatim(p3,run=TRUE,toDOT=TRUE)
```
