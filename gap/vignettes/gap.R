...
###################################################
### code chunk number 1: gap.Rnw:267-273
###################################################
library(gap)
# pedigree diagram
data(lukas)
...
###################################################
### code chunk number 2: gap.Rnw:279-305
###################################################
...
###################################################
### code chunk number 3: gap.Rnw:313-351
###################################################
library(gap)
models <- matrix(c(
         4.0, 0.01,
...
###################################################
### code chunk number 4: gap.Rnw:356-384
###################################################
library(gap)
...
###################################################
### code chunk number 5: gap.Rnw:389-436
###################################################
library(gap)
# ARIC study
outfile <- "aric.txt"
...
###################################################
### code chunk number 6: gap.Rnw:444-451
###################################################
library(gap)
u_obs <- runif(1000)
...
###################################################
### code chunk number 7: gap.Rnw:457-470
###################################################
...
###################################################
### code chunk number 8: gap.Rnw:474-488
###################################################
library(gap.datasets)
...
###################################################
### code chunk number 9: gap.Rnw:498-501
###################################################
library(gap)
library(gap.datasets)
circos.mhtplot()
...
###################################################
### code chunk number 10: gap.Rnw:505-508
###################################################
library(gap.datasets)
...
###################################################
### code chunk number 11: gap.Rnw:513-523 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 12: gap.Rnw:529-531
###################################################
...
###################################################
### code chunk number 13: gap.Rnw:542-543
###################################################
cnvplot(cnv)


###################################################
### code chunk number 14: gap.Rnw:548-557
###################################################
library(gap)
...
###################################################
### code chunk number 15: gap.Rnw:564-566
###################################################
data(OPG)
...
###################################################
### code chunk number 16: gap.Rnw:579-583
###################################################
library(cowplot)
library(ggplot2)
library(gap)
...
###################################################
### code chunk number 17: gap.Rnw:605-609
###################################################
library(gap)
search()
lsf.str("package:gap")
