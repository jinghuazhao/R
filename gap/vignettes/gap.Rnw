...
\includegraphics[height=14cm,width=14cm]{figures/circos-mhtplot.pdf}
...
\includegraphics[height=14cm,width=14cm]{figures/miamiplot.png}
...
\includegraphics[height=14cm,width=14cm]{figures/IL12B.png}
...
\includegraphics[height=14cm,width=14cm]{figures/cnvplot.pdf}
...
\includegraphics[height=10cm,width=10cm]{figures/OPG.pdf}
...
\includegraphics[height=10cm,width=10cm]{figures/INF1_CAD-FEV1.pdf}
