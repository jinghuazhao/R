...
circos.cis.vs.trans.plot & circos plot of cis/trans classificaiton\\
...
METAL_forest      &      forest plot as R/meta's forest for METAL outputs\\
mhtplot           &      Manhattan plot\\
mhtplot2          &      Manhattan plot with annotations\\
miamiplot         &      Miami plot (experimental)\\
